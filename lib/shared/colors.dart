...
const primaryColor = Color.fromRGBO(24, 123, 180, 1);
...
class Palette {
  static const MaterialColor kToDark = MaterialColor(
    0xff5c3e94, // 0% comes in here, this will be color picked if no shade is selected when defining a Color property which doesn’t require a swatch.
    <int, Color>{
